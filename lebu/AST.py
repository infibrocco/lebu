...
class ExpressionStatement(Statement):
    ...
    def json(self) -> dict:
        return {"type": self.type().value, "expr": self.expr.json()}


class LetStatement(Statement):
    def __init__(
        self, name: Expression = None, value: Expression = None, value_type: str = None
    ) -> None:
        self.name = name
        self.value = value
        self.value_type = value_type
...
class ReturnStatement(Statement):
    ...
    def json(self) -> dict:
        return {"type": self.type().value, "return_value": self.return_value.json()}
...
class AssignStatement(Statement):
    def __init__(
        self,
        ident: Expression = None,
        operator: str = None,
        right_value: Expression = None,
    ) -> None:
        self.ident = ident
...
class ForStatement(Statement):
    def __init__(
        self,
        var_declaration: LetStatement = None,
        condition: Expression = None,
        action: AssignStatement = None,
        body: BlockStatement = None,
    ) -> None:
...
class ImportStatement(Statement):
    ...
    def json(self) -> dict:
        return {"type": self.type().value, "file_path": self.file_path}
...
class InfixExpression(Expression):
    def __init__(
        self, left_node: Expression, operator: str, right_node: Expression = None
    ):
...
class CallExpression(Expression):
    def __init__(
        self, function: Expression = None, arguments: list[Expression] = None
    ) -> None:
