...
class Parser:
    ...
    def __parse_statement(self) -> Statement:
        if (
            ...
            and self.__peek_token_is_assignment()
        ):
    ...
    def __parse_function_parameters(self) -> list[FunctionParameter]:
        ...
        first_param: FunctionParameter = FunctionParameter(
    ...
    def __parse_infix_expression(self, left_node: Expression) -> Expression:
        ...
        infix_expr: InfixExpression = InfixExpression(
            left_node=left_node, operator=self.current_token.literal
        )
    ...
    def __parse_float_literal(self) -> FloatLiteral:
        ...
        try:
            ...
            self.errors.append(
                f"Could not parse `{self.current_token.literal}` as an float."
            )
            return None
    ...
    def __parse_prefix_expression(self) -> PrefixExpression:
        prefix_expr: PrefixExpression = PrefixExpression(
